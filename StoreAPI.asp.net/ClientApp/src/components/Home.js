		...
		<div className="container">
			...
			<div className="row">
				...
				<div className="col-md-4 col-xs-6">
					<div className="shop">
						<div className="shop-img">
							<img src="../static/img/shop01.png" alt=""></img>
				...
				<div className="col-md-4 col-xs-6">
					<div className="shop">
						<div className="shop-img">
							<img src="../static/img/shop03.png" alt=""></img>
						</div>
						<div className="shop-body">
							<h3>Accessories<br></br>Collection</h3>
							<a href="#" className="cta-btn">Shop now <i className="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
				</div>
				...
				<div className="col-md-4 col-xs-6">
					<div className="shop">
						<div className="shop-img">
							<img src="../static/img/shop02.png" alt=""></img>
						</div>
						<div className="shop-body">
								...
								<div className="products-slick" data-nav="#slick-nav-1">
									...
									<div className="product">
										<div className="product-img">
											<img src="../static/img/product01.png" alt=""></img>
